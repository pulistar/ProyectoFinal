...
class peliculas_serializer(serializers.ModelSerializer): 
    class Meta: 
        model= peliculas
        fields= ['id','titulo', 'sinopsis', 'genero', 'director','actores', 'fecha_estreno','duracion']


class series_serializer(serializers.ModelSerializer):
    class Meta:
        model = series
        fields = ['id','titulo', 'sinopsis', 'genero', 'director', 'actores','fecha_estreno', 'temporada', 'duracion']